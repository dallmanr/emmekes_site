    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="nav blog-nav">
          ...
          <a class="nav-link active" href="#">Garden</a>
        ...
        <div class="col-sm-8 blog-main">
          <div class="blog-post">
            <?php
                ...
                $galleryArray = $gallery->readImageDirectory('images/garden');

                include_once('resources/UberGallery.php'); $gallery = UberGallery::init()->createGallery('images/garden');
                ?>
          </div><!-- /.blog-post -->
        </div><!-- /.blog-main -->
